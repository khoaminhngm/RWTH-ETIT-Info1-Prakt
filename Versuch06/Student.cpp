...
/**
 * @brief Vergleichsoperator für zwei Studenten.
 *
 * Vergleicht zwei Studenten auf Basis ihrer Matrikelnummer.
 * @param a Erster Student
 * @param b Zweiter Student
 * @return true, wenn beide die gleiche Matrikelnummer haben, sonst false
 */
bool operator==(const Student& a, const Student& b) {
	return a.getMatNr() == b.getMatNr();
}
